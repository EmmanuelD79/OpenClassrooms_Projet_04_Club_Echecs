...
START = {
    ...
    1: [" 1 - Gérer les tournois", "setattr(self, 'dict_menu', MENU.TOURNAMENT_MANAGE)"],
    2: [" 2 - Gérer les joueurs", "setattr(self, 'dict_menu', MENU.ACTORS_MANAGE)"],
...
ACTORS_MANAGE = {
    ...
    1: [" 1 - Ajouter un nouveau joueur",
        "self.actors_manager.create_actor(MENU.CREATE_PLAYER)"],
    ...
    0: [" 0 - Revenir au menu précedent", "setattr(self, 'dict_menu', MENU.START)"]
}

TOURNAMENT_MANAGE = {
    "titre": "Bienvenue dans le menu de gestion des tournois",
    1: [" 1 - Ajouter un nouveau tournoi",
        "self.tournament_manager.create_tournament(MENU.CREATE_TOURNAMENT)"],
